...
fullScreen();
  ...
  rect (375, 125, 75, 75); //eye left
  rect (375, 125, 75, 75); //eye right
  rectMode (CENTER);
...
void draw () {
  ...
  rect (375, 125, 75, 75);//eye left
  rect (125, 125, 90, 90); //eye left outside
  rect (375, 125, 75, 75); //eye right
  rect (375, 125, 90, 90); //eye right outside
  rectMode (CENTER);
  ellipse (250, 250, 50, 50); //nose
  ellipse( 250, 340, 310, 80);//Mouth
  rectMode (CORNER);
